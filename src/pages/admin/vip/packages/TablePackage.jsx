...
export default function TableCategory({ handleEdit }) {
    ...
    const [packageIdToDelete, setPackageIdToDelete] = useState(null); // Lưu ID của thể loại cần xóa
    ...
    const handleOpenDelete = (id) => {
        setOpenDelete(true);
        setPackageIdToDelete(id); // Lưu ID của thể loại cần xóa
    }
    ...
    const handleDelete = async () => {
        ...
        await deleteDocument("packages", packageIdToDelete);
    ...
    return (
        <>
            ...
            <TablePaginationPage rowsPerPage={rowsPerPage} page={page} handleChangePage={handleChangePage} handleChangeRowsPerPage={handleChangeRowsPerPage} count={packages.length} />
        </>
    );
}

...
export default function TableCategory({ handleEdit }) {
    ...
    const [sectionIdToDelete, setSectionIdToDelete] = useState(null); // Lưu ID của thể loại cần xóa
    ...
    const handleOpenDelete = (id) => {
        setOpenDelete(true);
        setSectionIdToDelete(id); // Lưu ID của thể loại cần xóa
    }
    ...
    const handleDelete = async () => {
        ...
        await deleteDocument("sections", sectionIdToDelete);
        ...
        <>
            <TableContainer component={Paper}>
                <Table sx={{ minWidth: 700 }} aria-label="customized table">
                    ...
                    <TableBody>
                        {sections?.slice(page * rowsPerPage, page * rowsPerPage + rowsPerPage).map((row, index) => (
            ...
            <TablePaginationPage rowsPerPage={rowsPerPage} page={page} handleChangePage={handleChangePage} handleChangeRowsPerPage={handleChangeRowsPerPage} count={sections.length} />
        </>
    );
}
